...
\hypersetup{
  pdftitle={Exhibition Pamphlet (Working title)},
...
\title{Exhibition Pamphlet (Working title)}
\author{Dragon team}
...
\chapter*{Artifact 5}\label{artifact5}}
\addcontentsline{toc}{chapter}{Artifact 5}
